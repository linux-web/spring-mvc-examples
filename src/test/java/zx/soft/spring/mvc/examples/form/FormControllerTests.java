...
public class FormControllerTests {
	...
	public void submitSuccess() throws Exception {
		...
		this.mockMvc
				.perform(
						post("/form").param("name", "Joe").param("age", "56").param("birthDate", "1941-12-16")
				...
				.andExpect(
						flash().attribute(
								...
								"Form submitted successfully.  Bound properties name='Joe', age=56, "
										+ "birthDate=Tue Dec 16 00:00:00 " + timezone
	...
	public void submitSuccessAjax() throws Exception {
		...
		this.mockMvc
				.perform(
						post("/form").header("X-Requested-With", "XMLHttpRequest").param("name", "Joe")
