...
import zx.soft.spring.mvc.examples.convert.ConvertController;
import zx.soft.spring.mvc.examples.convert.MaskFormatAnnotationFormatterFactory;
	...
	public void valueOf() throws Exception {
		this.mockMvc.perform(get("/convert/value?value=123456789"))
				.andExpect(content().string(startsWith(
						"Converted value object zx.soft.spring.mvc.examples.convert.SocialSecurityNumber")));
	}
